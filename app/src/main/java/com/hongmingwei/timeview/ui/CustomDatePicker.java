package com.hongmingwei.timeview.ui;
...
import com.hongmingwei.timeview.R;
...
/**
 * Created by hongmingwei on 2016/6/5 15:26
 */
public class CustomDatePicker {
    ...
    private DateTimeView year_pv, month_pv, day_pv, hour_pv, minute_pv;
    ...
    private void initView() {
        year_pv = (DateTimeView) datePickerDialog.findViewById(R.id.year_pv);
        month_pv = (DateTimeView) datePickerDialog.findViewById(R.id.month_pv);
        day_pv = (DateTimeView) datePickerDialog.findViewById(R.id.day_pv);
        hour_pv = (DateTimeView) datePickerDialog.findViewById(R.id.hour_pv);
        minute_pv = (DateTimeView) datePickerDialog.findViewById(R.id.minute_pv);
    ...
    private void addListener() {
        year_pv.setOnSelectListener(new DateTimeView.OnSelectListener() {
            @Override
        ...
        month_pv.setOnSelectListener(new DateTimeView.OnSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        day_pv.setOnSelectListener(new DateTimeView.OnSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        hour_pv.setOnSelectListener(new DateTimeView.OnSelectListener() {
            @Override
            public void onSelect(String text) {
        ...
        minute_pv.setOnSelectListener(new DateTimeView.OnSelectListener() {
            @Override
            public void onSelect(String text) {
